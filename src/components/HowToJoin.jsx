...
const STEPS = [
  { step: '01', icon: '📦', title: 'Launch Minecraft',  color: 'var(--stew-green)',  desc: "Open Minecraft Java 1.20+ or Bedrock Edition on any platform. Make sure you're fully updated for the best experience." },
  { step: '02', icon: '🌐', title: 'Add the Server',    color: 'var(--stew-gold)',   desc: 'Go to Multiplayer → Add Server. Paste the server address into the Server Address field and hit Done.' },
  { step: '03', icon: '🍲', title: 'Join & Brew',       color: 'var(--stew-purple)', desc: "Click Join Server. Talk to the Society Greeter to get your starter kit and first recipe scroll. You're in." },
];
      ...
      <div style={{ maxWidth: '1320px', margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '80px' }}>
          <span className="font-mono" style={{
            fontSize: '0.7rem', fontWeight: 600, color: 'var(--stew-green)',
            letterSpacing: '0.28em', textTransform: 'uppercase',
            display: 'block', marginBottom: '18px',
          }}>— Join the Society —</span>
          ...
          <p style={{
            ...
            color: 'var(--muted)', maxWidth: '440px', margin: '0 auto', lineHeight: 1.75,
          }}>
        ...
        <div style={{
          ...
          {STEPS.map((s, i) => (
            ...
            >
              ...
              <div style={{ fontSize: '2.4rem', marginBottom: '22px' }}>{s.icon}</div>

              <span className="font-mono" style={{
                fontSize: '0.62rem', fontWeight: 700,
                color: s.color, letterSpacing: '0.22em',
              ...
              <h3 className="font-display" style={{
                ...
                color: 'var(--cream)', marginBottom: '14px', letterSpacing: '-0.015em',
              }}>
                {s.title}
              </h3>
              ...
              <p style={{
                ...
                color: 'var(--muted)', lineHeight: 1.75, margin: 0,
              }}>
                {s.desc}
              </p>
            </div>
        ...
        <div style={{
          ...
          <div style={{ position: 'relative' }}>
            <span className="font-mono" style={{
              fontSize: '0.7rem', fontWeight: 700, color: 'var(--stew-green)',
