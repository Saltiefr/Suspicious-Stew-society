...
function StatCard({ stat, index, active }) {
  ...
  return (
    ...
    >
      ...
      <div style={{ fontSize: '2.6rem', marginBottom: '20px', display: 'block', filter: `drop-shadow(0 4px 12px ${stat.color}44)`, transition: 'transform 0.3s', transform: hov ? 'scale(1.15)' : 'scale(1)' }}>
        {stat.icon}
      </div>
...
export default function Stats() {
  ...
  return (
    <section id="stats" ref={ref} style={{ padding: '120px 80px', position: 'relative', zIndex: 1, borderTop: '1px solid rgba(245,234,214,0.05)' }}>
